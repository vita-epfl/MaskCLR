...
parser = argparse.ArgumentParser(
    description="PyTorch implementation of MotionBERT++")
...
parser.add_argument('--use_tcl_sampling', default=False, action="store_true", help='Use TCL sampling')
parser.add_argument('--num_segments', type=int, default=243)
parser.add_argument('--second_segments', default=4, type=int, help='no of segments for second branch')

parser.add_argument('--sel_key', type=str, default="imgs")
parser.add_argument('--combine_skl_imgs', default=False, action="store_true", help='Combine skeleton imgs into 1 img/frame')
parser.add_argument('--n_channels', type=int, default=3)

parser.add_argument('--bw_skl', default=False, action="store_true", help='Use black and white skeletons')
parser.add_argument('--bw_th', type=int, default=120)

parser.add_argument('--using_model', type=str, default="mb")

# for Motionbert
parser.add_argument('--pretrained', default='checkpoint', type=str, metavar='PATH', help='pretrained checkpoint directory')
...
parser.add_argument('--valbatchsize', default=2, type=int, help='mini-batch size for validation')
...
parser.add_argument('--finetune_lr', default=0.002, type=float, help='set fine tune lr for last stage PL')
parser.add_argument('--gamma_finetune',default=1.0, type=float, help= 'weight for pl_loss')
...
parser.add_argument('--mu',default=3, type=float, help= 'coefficient for unlabeled data')
