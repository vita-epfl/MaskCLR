...
ann_file = '/home/ossamaabdelfattah/TCL/datasets/ntu60/Frames/ntu60_hrnet.pkl'
...
# optimizer
optimizer = dict(type='SGD', lr=0.01, momentum=0.6, weight_decay=0.0003)  # this lr is used for 8 gpus
